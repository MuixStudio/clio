...
// WebhookHandler handles incoming webhook alerts.
type WebhookHandler struct {
	d dependencies
}

// NewWebhookHandler returns a WebhookHandler.
func NewWebhookHandler(d dependencies) *WebhookHandler {
	return &WebhookHandler{d: d}
}
