...
export function DataGrid<TData>({
  ...
  return (
    <div
      ...
      dir={dir}
      {...props}
      className={cn("relative flex w-full flex-col", className, classNames?.wrapper)}
    >
      ...
      <div
        ...
        tabIndex={0}
        ref={dataGridRef}
        className={cn("relative grid select-none overflow-auto rounded-md border focus:outline-none", classNames?.grid)}
        style={{
          ...columnSizeVars,
          maxHeight: `100%`,
        }}
      ...
      >
        <div
          ...
          ref={headerRef}
          className={cn("sticky top-0 z-10 grid border-b bg-background", classNames?.header)}
        >
          {table.getHeaderGroups().map((headerGroup, rowIndex) => (
            <div
              ...
              tabIndex={-1}
              className={cn("flex w-full", classNames?.headerRow)}
            >
        ...
        <div
          role="rowgroup"
          data-slot="grid-body"
          className={cn("relative grid", classNames?.body)}
          style={{
        ...
        {!readOnly && onRowAdd && (
          <div
            ...
            ref={footerRef}
            className={cn("sticky bottom-0 z-10 grid border-t bg-background", classNames?.footer)}
          >
            <div
              role="row"
              ...
              tabIndex={-1}
              className={cn("flex w-full", classNames?.addRow)}
            >
              <div
                role="gridcell"
                tabIndex={0}
