...
import { VisuallyHidden, useRadio } from "@heroui/react";
import { cn } from "@heroui/react";

type ThemeCustomRadioProps = {
  variant: "light" | "dark";
} & RadioProps;
...
export const ThemeCustomRadio = (props: ThemeCustomRadioProps) => {
  ...
  return (
    <Component
      {...getBaseProps()}
      className={cn(
        "hover:bg-content2 group inline-flex flex-row-reverse justify-between overflow-visible",
        "rounded-large border-1 border-default-200 max-w-[300px] cursor-pointer gap-4 px-4 py-2.5 shadow-md",
